...
extension AudioAggregateDevice.DriftCompensationQuality {
    ...
    public static var minimum: Self { Self(unsafe: kAudioAggregateDriftCompensationMinQuality) }
    ...
    public static var low: Self { Self(unsafe: kAudioAggregateDriftCompensationLowQuality) }
    ...
    public static var medium: Self { Self(unsafe: kAudioAggregateDriftCompensationMediumQuality) }
    ...
    public static var high: Self { Self(unsafe: kAudioAggregateDriftCompensationHighQuality) }
    ...
    public static var maximum: Self { Self(unsafe: kAudioAggregateDriftCompensationMaxQuality) }
}
