...
extension AudioProperty where SelectorConstant == AudioSubDevicePropertySelectorConstant {
    nonisolated
...
extension AudioProperty where SelectorConstant == AudioSubDevicePropertySelectorConstant, Qualifier == Never, Value == Float64 {
    nonisolated
...
extension AudioProperty where SelectorConstant == AudioSubDevicePropertySelectorConstant, Qualifier == Never, Value == Bool {
    nonisolated
...
extension AudioProperty where SelectorConstant == AudioSubDevicePropertySelectorConstant, Qualifier == Never, Value == UInt32 {
    nonisolated
