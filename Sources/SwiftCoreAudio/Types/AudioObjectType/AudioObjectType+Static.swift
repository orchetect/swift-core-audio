...
extension AudioObjectType where Self == AudioObjectConcreteType<AudioPlugIn> {
    ...
    public static var plugIn: Self { .init(classID: .plugIn) }
}
...
extension AudioObjectType where Self == AudioObjectConcreteType<AudioTransportManager> {
    ...
    public static var transportManager: Self { .init(classID: .transportManager) }
}
...
extension AudioObjectType where Self == AudioObjectConcreteType<AudioBox> {
    ...
    public static var box: Self { .init(classID: .box) }
}
...
extension AudioObjectType where Self == AudioObjectConcreteType<AudioDevice> {
    ...
    public static var device: Self { .init(classID: .device) }
}
...
extension AudioObjectType where Self == AudioObjectConcreteType<AudioClock> {
    ...
    public static var clock: Self { .init(classID: .clock) }
}
...
extension AudioObjectType where Self == AudioObjectConcreteType<AudioEndPointDevice> {
    ...
    public static var endPointDevice: Self { .init(classID: .endPointDevice) }
}
...
extension AudioObjectType where Self == AudioObjectConcreteType<AnyAudioObject> {
    ...
    public static var endPoint: Self { .init(classID: .endPoint) }
}
...
extension AudioObjectType where Self == AudioObjectConcreteType<AudioStream> {
    ...
    public static var stream: Self { .init(classID: .stream) }
}
...
extension AudioObjectType where Self == AudioObjectConcreteType<AudioControl> {
    ...
    public static var control: Self { .init(classID: .control) }
}

// TODO: replace `AnyAudioObject` with type name after concrete type is implemented
extension AudioObjectType where Self == AudioObjectConcreteType<AnyAudioObject> {
    /// The concrete type corresponding to the `AudioSliderControl` class.
    public static var sliderControl: Self { .init(classID: .sliderControl) }
}
...
extension AudioObjectType where Self == AudioObjectConcreteType<AudioLevelControl> {
    ...
    public static var levelControl: Self { .init(classID: .levelControl) }
}
...
extension AudioObjectType where Self == AudioObjectConcreteType<AnyAudioObject> {
    ...
    public static var volumeControl: Self { .init(classID: .volumeControl) }
 }
...
extension AudioObjectType where Self == AudioObjectConcreteType<AnyAudioObject> {
    ...
    public static var lfeVolumeControl: Self { .init(classID: .lfeVolumeControl) }
}
...
extension AudioObjectType where Self == AudioObjectConcreteType<AudioBooleanControl> {
    ...
    public static var booleanControl: Self { .init(classID: .booleanControl) }
}
...
extension AudioObjectType where Self == AudioObjectConcreteType<AnyAudioObject> {
    ...
    public static var muteControl: Self { .init(classID: .muteControl) }
}
...
extension AudioObjectType where Self == AudioObjectConcreteType<AnyAudioObject> {
    ...
    /// inaudible.
    public static var soloControl: Self { .init(classID: .soloControl) }
}
...
extension AudioObjectType where Self == AudioObjectConcreteType<AnyAudioObject> {
    ...
    public static var jackControl: Self { .init(classID: .jackControl) }
}
...
extension AudioObjectType where Self == AudioObjectConcreteType<AnyAudioObject> {
    ...
    /// `AudioMuteControl`.
    public static var lfeMuteControl: Self { .init(classID: .lfeMuteControl) }
}
...
extension AudioObjectType where Self == AudioObjectConcreteType<AnyAudioObject> {
    ...
    public static var phantomPowerControl: Self { .init(classID: .phantomPowerControl) }
}
...
extension AudioObjectType where Self == AudioObjectConcreteType<AnyAudioObject> {
    ...
    public static var phaseInvertControl: Self { .init(classID: .phaseInvertControl) }
}
...
extension AudioObjectType where Self == AudioObjectConcreteType<AnyAudioObject> {
    ...
    public static var clipLightControl: Self { .init(classID: .clipLightControl) }
}
...
extension AudioObjectType where Self == AudioObjectConcreteType<AnyAudioObject> {
    ...
    public static var talkbackControl: Self { .init(classID: .talkbackControl) }
}
...
extension AudioObjectType where Self == AudioObjectConcreteType<AnyAudioObject> {
    ...
    public static var listenbackControl: Self { .init(classID: .listenbackControl) }
}
...
extension AudioObjectType where Self == AudioObjectConcreteType<AudioSelectorControl> {
    ...
    public static var selectorControl: Self { .init(classID: .selectorControl) }
}
...
extension AudioObjectType where Self == AudioObjectConcreteType<AnyAudioObject> {
    ...
    public static var dataSourceControl: Self { .init(classID: .dataSourceControl) }
}
...
extension AudioObjectType where Self == AudioObjectConcreteType<AnyAudioObject> {
    ...
    public static var dataDestinationControl: Self { .init(classID: .dataDestinationControl) }
}
...
extension AudioObjectType where Self == AudioObjectConcreteType<AnyAudioObject> {
    ...
    public static var clockSourceControl: Self { .init(classID: .clockSourceControl) }
}
...
extension AudioObjectType where Self == AudioObjectConcreteType<AnyAudioObject> {
    ...
    public static var lineLevelControl: Self { .init(classID: .lineLevelControl) }
}
...
extension AudioObjectType where Self == AudioObjectConcreteType<AnyAudioObject> {
    ...
    public static var highPassFilterControl: Self { .init(classID: .highPassFilterControl) }
}
...
extension AudioObjectType where Self == AudioObjectConcreteType<AudioStereoPanControl> {
    ...
    public static var stereoPanControl: Self { .init(classID: .stereoPanControl) }
}
...
extension AudioObjectType where Self == AudioObjectConcreteType<AudioSystem> {
    ...
    public static var system: Self { .init(classID: .system) }
}
...
extension AudioObjectType where Self == AudioObjectConcreteType<AudioAggregateDevice> {
    ...
    public static var aggregate: Self { .init(classID: .aggregate) }
}
...
extension AudioObjectType where Self == AudioObjectConcreteType<AudioSubDevice> {
    ...
    public static var subdevice: Self { .init(classID: .subdevice) }
}
...
extension AudioObjectType where Self == AudioObjectConcreteType<AudioSubTap> {
    ...
    public static var subtap: Self { .init(classID: .subtap) }
}
...
extension AudioObjectType where Self == AudioObjectConcreteType<AudioProcess> {
    ...
    public static var process: Self { .init(classID: .process) }
}
...
extension AudioObjectType where Self == AudioObjectConcreteType<AudioTap> {
    ...
    public static var tap: Self { .init(classID: .tap) }
}
...
extension AudioObjectType where Self == AudioObjectConcreteType<AnyAudioObject> {
    ...
    public static var iSubOwnerControl: Self { .init(classID: .iSubOwnerControl) }
}

// TODO: replace `AnyAudioObject` with type name after concrete type is implemented
extension AudioObjectType where Self == AudioObjectConcreteType<AnyAudioObject> {
    /// A subclass of the `AudioLevelControl` class for the boot chime of the CPU.
    public static var bootChimeVolumeControl: Self { .init(classID: .bootChimeVolumeControl) }
}
