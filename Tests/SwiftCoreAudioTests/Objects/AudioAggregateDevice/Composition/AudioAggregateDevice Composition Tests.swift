...
struct AudioAggregateDevice_Composition_Tests {
    ...
    @Test
    func baselineCompositionCheck() async throws {
    ...
    @Test
    func baselineCompositionCFDictionaryCheck() async throws {
    ...
    @Test
    func baselineCompositionDictionaryCheck() async throws {
    ...
    @Test
    func compositionInitFromCFDictionary() async throws {
        // decode CFDictionary
        let cfDict = Self.sampleCompositionCFDictionary as NSDictionary
    ...
    @Test
    func compositionInitFromDictionary() async throws {
        // decode CFDictionary
        let dict = Self.sampleCompositionDictionary
    ...
    @Test
    func compositionCFDictionary() async throws {
    ...
    @Test
    func compositionDictionary() async throws {
        let comp = Self.sampleComposition
    ...
    @Test
    func compositionEquatable() async throws {
    ...
    @Test
    func emptyCompositionCFDictionary() async throws {
    ...
    @Test
    func compositionInitFromEmptyCFDictionary() async throws {
    ...
    @Test
    func unrecognizedKeys() async throws {
...
extension AudioAggregateDevice_Composition_Tests {
    static var dummyUnknownKey: String { "Dummy Unknown Key" }
...
extension AudioAggregateDevice_Composition_Tests {
    static func checkComposition(
        ...
        // subdevices
        try Self.checkSubDevices(compositionArray: comp.subdevices)
        
        // subtaps
        try Self.checkSubTaps(compositionArray: comp.subtaps)
